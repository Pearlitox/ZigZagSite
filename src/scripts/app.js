...
// Liste de phrases spécifiques pour chaque élément
const phrasesList = [
  ["Introduction", "Le TDAH"],       // Phrases pour le deuxième titre
  ["Mais d'abord...", "C'est quoi le TDAH ?"],  // Phrases pour le premier titre
  ["Origine du projet", "Nos recherches"],       // Phrases pour le deuxième titre
  // Ajoute d'autres listes de phrases pour d'autres éléments
];

// Sélectionne tous les éléments ayant la classe 'scramble-text'
const elements = document.querySelectorAll('.titleAnim');

elements.forEach((el, index) => {
  const fx = new TextScramble(el);
  const phrases = phrasesList[index];  // Utilise les phrases spécifiques pour cet élément
